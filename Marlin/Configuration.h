...
#define CUSTOM_MACHINE_NAME "Anycubic Kossel LR+"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -19.8  // Increase this if the first layer is too thin (remember: it's a negative number so increase means closer to zero).
